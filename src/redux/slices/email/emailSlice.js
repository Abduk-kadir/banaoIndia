...
export const enterEmailAction=createAsyncThunk('/email/enter',async({email},{rejectWithValue,getState,dispatch})=>{
       try{
...
export const emailVerifyAction=createAsyncThunk('/email/verify',async({email,otp},{rejectWithValue,getState,dispatch})=>{
